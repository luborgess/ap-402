...
const FooterComponent = () => (
  <footer className="text-center py-4">
    <a 
      href="https://instagram.com/luborges.me" 
      target="_blank" 
      rel="noopener noreferrer" 
      className="text-white/70 hover:text-black transition-colors text-sm font-medium"
    >
      made by @luborges.me
    </a>
  </footer>
...
const LaundrySchedule = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <Card className="bg-white/70 shadow-lg backdrop-blur-md border-0">
        ...
        <div className="mt-4 bg-white/70 rounded-lg p-4 shadow-lg backdrop-blur-md">
